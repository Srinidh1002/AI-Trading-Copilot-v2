"""Task 8 selected-market PAPER lifecycle and durable persistence runtime.
...
def execute_task8_selected_market_lifecycle(
    *,
    ...
    cycle_result = PaperOrchestrationCycleResultV1(
        cycle_result_id=(
            f"{selected_cycle.cycle_id}:"
            "task8:selected-lifecycle-result"
        ),
        cycle_id=selected_cycle.cycle_id,
        ...
        metadata={
            "scope": (
                "TASK8_SELECTED_MARKET_P6_P7_P8"
            ),
            "parent_cycle_id": (
                selected_planning
                .bridge
    ...
    if (
        ...
        raise RuntimeError(
            "Task 8 cycle journal integrity mismatch"
        )
