...
class TradePlanningPolicyV1:
 ...
 def __post_init__(self):
  ...
  if self.stop_loss_method not in {'ATR','STRUCTURE','PREMIUM_FRACTION','HYBRID'} or self.target_method not in {'DEPLOYED_CAPITAL_RETURN','RISK_MULTIPLE','ATR','EXPECTED_MOVE','STRUCTURE','HYBRID'} or self.entry_reference_method not in {'OPTION_MID','OPTION_ASK','LAST_TRADED_PRICE','SIGNAL_REFERENCE','HYBRID'}:raise ValueError('method')
