...
"canonical_directional_policy_v1": ("CanonicalDirectionalPolicyV1",),
"canonical_evidence_family_v1": ("CanonicalEvidenceFamilyContributionV1","CanonicalEvidenceFamilySetV1"),
"provider_capability_registry_v1": ("ProviderCapabilityRegistryV1","default_provider_capability_registry"),
"canonical_policy_provenance_v1": ("CanonicalPolicyProvenanceV1",),
"pre_market_brain_v1": ("PreMarketBrainV1",),
"post_entry_authority_policy_v1": ("PostEntryAuthorityPolicyV1",),
"task9_run_classification_v1": ("OFFICIAL_CERTIFICATION","DIAGNOSTIC_NON_COUNTING","validate_task9_run_classification"),
