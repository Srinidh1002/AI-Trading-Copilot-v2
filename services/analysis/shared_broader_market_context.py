...
def build_certified_shared_broader_context(*, nifty_observation: AngelLiveMarketObservationV1, sensex_observation: AngelLiveMarketObservationV1, evaluated_at: datetime) -> CertifiedSharedMarketContextV1:
    ...
    if CORRELATION_TIMEFRAME not in nifty or CORRELATION_TIMEFRAME not in sensex:
        ...
        nifty_result = build_broader_market_intelligence(
            primary_series=nifty_series, related_series=sensex_series, breadth_snapshot=None, volatility_snapshot=None,
        ...
        sensex_result = build_broader_market_intelligence(
            primary_series=sensex_series, related_series=nifty_series, breadth_snapshot=None, volatility_snapshot=None,
    ...
    return CertifiedSharedMarketContextV1(
        ...
        source_timestamps=timestamps, blockers=blockers,
    )
