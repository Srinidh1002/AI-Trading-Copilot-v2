...
def test_global_context_import_isolated(token):
 code=f"import importlib,sys;importlib.import_module('services.external_context.global');print(any({token!r} in x.lower() for x in sys.modules))"
