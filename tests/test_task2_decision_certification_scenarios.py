...
@pytest.mark.parametrize("scenario,nifty,sensex,selected,parent,status",(
 ("NIFTY_CALL_WINS","CALL","WAIT","NIFTY","CALL","SELECTED"),("NIFTY_PUT_WINS","PUT","WAIT","NIFTY","PUT","SELECTED"),("SENSEX_CALL_WINS","WAIT","CALL","SENSEX","CALL","SELECTED"),("SENSEX_PUT_WINS","WAIT","PUT","SENSEX","PUT","SELECTED"),("BOTH_WAIT","WAIT","WAIT","NONE","NO_TRADE","NO_TRADE"),("WAIT_AND_UNAVAILABLE","WAIT","NO_TRADE","NONE","NO_TRADE","NO_TRADE"),("BOTH_UNAVAILABLE","NO_TRADE","NO_TRADE","NONE","NO_TRADE","NO_TRADE"),("ONE_UNAVAILABLE_OTHER_CALL","NO_TRADE","CALL","SENSEX","CALL","SELECTED"),("ONE_UNAVAILABLE_OTHER_PUT","NO_TRADE","PUT","SENSEX","PUT","SELECTED"),("EQUAL_SCORE_CONFIDENCE_TIE","CALL","CALL","NIFTY","CALL","SELECTED"),("HIGHER_SCORE_WINS","CALL","CALL","SENSEX","CALL","SELECTED"),("SCORE_TIE_HIGHER_CONFIDENCE_WINS","CALL","CALL","SENSEX","CALL","SELECTED"),("CONFLICTING_CHILD","NO_TRADE","WAIT","NONE","NO_TRADE","NO_TRADE"),("REQUIRED_EVIDENCE_MISSING","NO_TRADE","WAIT","NONE","NO_TRADE","NO_TRADE"),("OPTIONAL_EXTERNAL_UNAVAILABLE","WAIT","WAIT","NONE","NO_TRADE","NO_TRADE"),("REGIME_BLOCKED","NO_TRADE","WAIT","NONE","NO_TRADE","NO_TRADE"),("GROUPED_PILLAR_PROVENANCE","CALL","WAIT","NIFTY","CALL","SELECTED"),("CONFIDENCE_LEDGER_DUPLICATE_INPUT","CALL","WAIT","NIFTY","CALL","SELECTED"),("SELECTED_ACTION_INVARIANT_FAILURE","WAIT","WAIT","NONE","NO_TRADE","NO_TRADE")))
