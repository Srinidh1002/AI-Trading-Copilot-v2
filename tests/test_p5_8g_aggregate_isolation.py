...
def test_aggregate_import_isolated(token):
 code=f"import importlib,sys;importlib.import_module('services.broader_market_intelligence.evaluator');print(any({token!r} in x.lower() for x in sys.modules))"
