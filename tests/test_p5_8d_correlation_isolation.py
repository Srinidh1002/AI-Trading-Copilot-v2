...
@pytest.mark.parametrize("module",("services.broader_market_intelligence","services.broader_market_intelligence.correlation"))
...
def test_correlation_import_has_no_forbidden_dependencies(module,token):
