...
@pytest.mark.parametrize("module",("services.broader_market_intelligence.breadth","services.contracts.market_breadth_snapshot_v1"))
...
def test_breadth_import_has_no_forbidden_dependencies(module,token):
