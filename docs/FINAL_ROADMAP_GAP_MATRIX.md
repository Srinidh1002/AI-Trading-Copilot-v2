...
| 2 | Two-market selection | parent coordinator/canary, Task 2C actions, and Task 2D typed explanations | PARTIAL | `two_market_parent_cycle_coordinator.py`, `pre_entry_market_action_v1`, `market_decision_explanation_v1` | final end-to-end certification remains pending | 1, 2A–2D | exact-once action and explanation evidence | 2E certification |
