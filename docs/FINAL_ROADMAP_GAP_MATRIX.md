...
| 2 | Two-market selection | parent coordinator/canary and Task 2C child action projection | PARTIAL | `two_market_parent_cycle_coordinator.py`, `pre_entry_market_action_v1` | evidence-grounded explanations remain pending | 1, 2A–2C | exact-once winner/loser and action evidence | 2D explanations |
