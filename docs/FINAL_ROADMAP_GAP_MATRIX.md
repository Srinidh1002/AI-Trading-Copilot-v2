...
| 2 | Fourteen-pillar evidence | typed P5 engines, candidates, and Task 2A contribution provenance | PARTIAL | `technical_intelligence`, `option_chain_intelligence`, `market_analysis_pillar_contribution_v1`, `market_regime`, `broader_market_intelligence` | final confidence certification | 1 | ordered pillar contribution matrix and fail-closed tests | 2A evidence closure |
